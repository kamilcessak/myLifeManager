...
function CalendarDayButton(
  ...
  const { ref: refFromPicker, ...buttonProps } = rest as typeof rest & {
  ...
  const mergedRef = React.useCallback(
    (node: HTMLButtonElement | null) => {
      ...
      if (typeof refFromPicker === "function") {
        refFromPicker(node)
      } else if (refFromPicker != null) {
        ;(refFromPicker as React.MutableRefObject<HTMLButtonElement | null>).current =
          node
      }
    },
    [refFromPicker]
